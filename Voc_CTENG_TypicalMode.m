...
f1 = 1;% movement frequency of TENG
...
Cfinal = 1000e-12; % final capacitance of tribo-material
...
%d1 = 100e-6; %tribo-material 1 thickness unit m
%eps1 = 0; %relative permittivity of tribo-material 1

%it should be noted that tribo-material 2 is the ionic layer, which has a
%variable capacitance under cyclic load

Cair = eps0*S./x; %capacitance of air
Cairo = eps0*S./xorigin;
%C1 = eps1*eps0*S/d1; %capacitance of tribo-material 1
C2 = c; %capacitance of ionic layer
C2o = corigin;
%CTENG = 1./(1./Cair+1/C1+1./C2);
% CTENG = 1./(1./Cair+1./C2);
% CTENGo = 1./(1./Cairo+1/C1+1./C2o);
